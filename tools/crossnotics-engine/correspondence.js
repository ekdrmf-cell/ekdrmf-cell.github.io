...
const SHI_SHEN_MEANING = {
  "비견": "나와 기운이 똑같은 존재로, 형제자매나 동료 같은 자리입니다. 힘을 합치면 든든하지만, 같은 걸 두고 겨루게 되면 만만치 않은 경쟁자가 되기도 합니다.",
  "겁재": "나와 비슷하지만 결이 살짝 다른 기운으로, 경쟁자에 가까운 자리입니다. 밀어붙이는 힘은 좋지만, 그만큼 손에 쥔 재물이 빠져나가기 쉽다고 봅니다.",
  "식신": "내가 스스로 만들어내는 기운으로, 표현력과 생활의 활력을 뜻합니다. 느긋하고 온화하게 자기만의 것을 빚어내는 창조력에 가깝습니다.",
  "상관": "내가 만들어내는 기운 중에서도 좀 더 날카로운 쪽입니다. 재능과 말솜씨가 뛰어나고 발상이 자유롭지만, 정해진 규칙과는 부딪히기 쉽습니다.",
  "편재": "내가 다루는 재물 중에서도 흘러 다니는 쪽입니다. 사업 수완이 좋고 여러 경로로 돈이 들어오지만, 그만큼 씀씀이도 여기저기로 흩어지기 쉽습니다.",
  "정재": "내가 다루는 재물 중에서도 차곡차곡 쌓이는 쪽입니다. 성실하고 계획적으로 모으는 안정적인 수입, 고정적인 벌이와 잘 맞습니다.",
  "칠살(편관)": "나를 강하게 누르는 기운으로, 부담과 긴장이 따르는 자리입니다. 힘들게 느껴질 수 있지만, 그만큼 도전정신과 밀어붙이는 추진력의 원천이 되기도 합니다.",
  "정관": "나를 적당히 다스려주는 기운으로, 명예와 책임감을 뜻합니다. 안정된 조직 생활, 사회적으로 인정받는 자리와 잘 맞습니다.",
  "편인": "나를 키워주는 기운 중에서도 남다른 쪽입니다. 특별한 재능이나 직관이 뛰어나지만, 독창적인 만큼 변덕스럽게 비칠 때도 있습니다.",
  "정인": "나를 키워주는 기운으로, 학문이나 문서와 관련된 운을 뜻합니다. 누군가에게 보호받는 듯한 안정감, 인정받고 명예를 얻는 것과 관련이 깊습니다.",
};
