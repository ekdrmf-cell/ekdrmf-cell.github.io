(function () {
  ...
  // 2026-08-23: "운세" 항목(unse/index.html) 제거 — 천지인운명관은 서비스허브와 별개
  // 사이트로 완전히 분리됐다(사용자 지시). 서비스허브 내비게이션에서는 더 이상 링크하지 않음.
  const nav = [
  ...
  // 2026-08-23: "운세 도구도 결제해야 하나요?" FAQ 항목 제거 — 천지인운명관(사주ㆍ궁합ㆍ
  // 타로 등)은 서비스허브와 별개 사이트로 분리됨.
  const FAQ_BOT_ITEMS = [
    { q: "서비스허브는 어떤 사이트인가요?", a: "게임·서비스(업무 자동화 시트)·전자책을 한 곳에서 제공하는 사이트예요. 게임은 무료, 서비스와 전자책은 실용 상품 위주로 판매하고 있어요." },
