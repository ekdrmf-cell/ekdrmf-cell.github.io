# -*- coding: utf-8 -*-
"""전자책 PDF의 페이지별 빈 여백을 검사하는 스크립트(gov-subsidy-guide 패턴 재사용).

페이지 하단 페이지번호 영역(6%)을 제외하고, 본문 영역에서 콘텐츠가 어디까지
차 있는지를 검사한다.
"""
import fitz
...
PDF = r"C:\Users\nalla\Desktop\서비스허브\products\ebook-writing-guide\전자책_만들어_팔기_가이드.pdf"
doc = fitz.open(PDF)
