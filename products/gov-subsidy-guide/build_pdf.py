...
term("정책자금(융자) vs 지원금(보조금)", "정책자금은 <b>빌리는 돈</b>입니다. 낮은 금리로 빌려주는 것이지 갚지 않아도 되는 돈이 아닙니다. 반면 지원금ㆍ보조금은 조건을 충족하면 <b>갚지 않아도 되는 돈</b>입니다. 공고문에서 이 둘을 헷갈리면 자금 계획에 큰 차질이 생기니 반드시 구분해서 읽어야 합니다.")
...
term("협약(협약체결)", "지원사업에 최종 선정된 이후, 지원 조건ㆍ의무사항ㆍ자금 집행 방법 등을 기관과 공식 계약하는 절차입니다. 협약서에 명시된 의무사항(정산보고, 사용처 제한 등)을 지키지 않으면 지원금 환수 대상이 될 수 있어 반드시 꼼꼼히 읽어야 합니다.")
